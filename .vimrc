...
" CONFIG:
" Colorscheme"{{{
" Colorscheme dictionnary"{{{
let g:colorSchemeList = {}
"}}}
" Default dark"{{{
let g:colorSchemeList['default dark'] = [
      \ 'set background=dark',
      \ 'colorscheme default'
      \ ]
"}}}
" Molokai dark"{{{
let g:colorSchemeList['molokai dark'] = [
      \ 'let g:rehash256 = 1',
      \ 'set background=dark',
      \ 'colorscheme molokai',
      \ "let g:airline_theme = 'badwolf'",
      \ 'call SwitchAirlineTheme("badwolf")'
      \ ]
"}}}
" Gruvbox dark"{{{
let g:colorSchemeList['gruvbox dark'] = [
      ...
      \ 'colorscheme gruvbox',
      \ 'call SwitchAirlineTheme("gruvbox")'
      \ ]
"}}}
" Gruvbox light"{{{
...
let g:colorSchemeList['gruvbox material dark'] = [
      ...
      \ 'call SwitchAirlineTheme("gruvbox_material")'
      \ ]
"}}}
" Colorscheme functions and commands"{{{
...
function! SwitchAirlineTheme(airlinetheme)
  command! -bar -nargs=? AirlineTheme a:airlinetheme | AirlineRefresh
endfunction

command! -bar -nargs=? -complete=customlist,<sid>Colo Colo call SwitchColorScheme(<f-args>)
call SwitchColorScheme(g:vimrc_color_scheme)
"}}}
"}}}
" Airline"{{{
